...
9. **Transition to implementation** — invoke og-writing-plans skill to create implementation plan

## Process Flow

```dot
digraph og_brainstorming {
    ...
    "Invoke og-writing-plans skill" [shape=doublecircle];
    ...
    "User reviews spec?" -> "Invoke og-writing-plans skill" [label="approved"];
}
```

**The terminal state is invoking og-writing-plans.** Do NOT invoke frontend-design, mcp-builder, or any other implementation skill. The ONLY skill you invoke after og-brainstorming is og-writing-plans.
...
- Invoke the og-writing-plans skill to create a detailed implementation plan
- Do NOT invoke any other skill. og-writing-plans is the next step.
...
`skills/brainstorming/visual-companion.md`  *(canonical location — shared with the modified `brainstorming` skill; never modified after upstream vendoring)*
