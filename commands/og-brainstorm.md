---
description: upstream superpowers 원본 brainstorming(자유 탐색 Socratic 방식)을 호출합니다. dj-superkit 확장(PRD/변경이력/위험주석/docs-pretty)을 우회하고 원본 그대로의 경험을 원할 때 사용.
---
...
| 항목 | `/brainstorm` (dj-superkit 확장) | `/og-brainstorm` (upstream 원본) |
|---|---|---|
