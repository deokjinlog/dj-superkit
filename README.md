...
### 프로덕션 코드를 안전하게 만드는 Claude Code 플러그인
...
<sub>upstream <a href="https://github.com/obra/superpowers">superpowers</a> 5.0.7 (MIT, Jesse Vincent) 의 한국어 실무 확장</sub>
...
이 저장소는 [superpowers](https://github.com/obra/superpowers) v5.0.7 풀 카피에 한국어 확장을 얹은 형태입니다. upstream 업데이트는 수동 머지로 따라가요.
...
<sub>한국어 Claude Code 워크플로우를 위해</sub>
