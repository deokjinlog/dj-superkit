...
<p>
  <img alt="Version" src="https://img.shields.io/badge/version-0.10.0-7c3aed?style=for-the-badge&labelColor=0d1117">
...
**dj-superkit 는** 단계마다 문서를 자동으로 정리해요:
...
**dj-superkit 는** 위험한 코드 줄마다 `# RISK(...)` 주석을 자동으로 붙여 줍니다. 배포 직전에는 `/audit-risk` 한 줄로 보안 / 비용 / 거버넌스를 한 번 더 훑어볼 수 있어요.
...
**dj-superkit 는** 단계마다 확인 게이트를 둡니다. *(v2.3.5+)* 자잘한 결정은 알아서, **위험한 결정만 사람에게** 물어봅니다.
...
| `learning-notes` | "학습 정리해줘" · "배운 거 노트로" | 학습노트.md + .html |
...
> 정확한 주문이 아니라 **의도**로 떠요. "배운 거 정리해줘"든 "학습노트로 남겨"든 뜻만 통하면 발동. 100% 확실히 하려면 슬래시 `/learning-notes` 처럼 직접 부르면 돼요.
...
<details>
<summary><b>전체 Skill 28 개</b></summary>
